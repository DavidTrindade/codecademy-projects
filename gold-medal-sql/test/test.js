...
const seededDb = new sqlite3.Database(
    './test/test_seed.sqlite',
...
describe('createCountryTable', function () {
    ...
    it('should return a SQL query string that creates a Country table with name, code, gdp, and population columns', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO Country (name, code, gdp, population) VALUES ('Angola', 'ANG', 25021974, 4101.47215182964)",
                error => {
                    if (error) {
    ...
    it('should return a SQL query string that creates a Country table with a required name column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO Country (code, gdp, population) VALUES ('ANG', 25021974, 4101.47215182964)",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
                    ) {
                        done();
                    } else {
                        done(new Error(error));
    ...
    it('should return a SQL query string that creates a Country table with a required code column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO Country (name, gdp, population) VALUES ('Angola', 25021974, 4101.47215182964)",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with non-required gdp and population columns', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO Country (name, code) VALUES ('Angola', 'ANG')",
                error => {
                    if (error) {
                        done(new Error(error));
                    } else {
...
describe('createGoldMedalTable', function () {
    ...
    it('should return a SQL query string that creates a table called GoldMedal', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.get(
                "SELECT name FROM sqlite_master WHERE type='table' AND name='GoldMedal'",
                (error, table) => {
                    if (error || !table) {
    ...
    it('should return a SQL query string that creates a GoldMedal table with all necessary columns', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, sport, discipline, city, country, season) VALUES (1991, 'Mike D', '100km', 'Men', 'Running', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (error) {
                        done(new Error(error));
                    } else {
    ...
    it('should return a SQL query string that creates a Country table with a required year column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (name, event, gender, sport, discipline, city, country, season) VALUES ('Mike D', '100km', 'Men', 'Running', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required name column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, event, gender, sport, discipline, city, country, season) VALUES (1991, '100km', 'Men', 'Running', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required event column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, gender, sport, discipline, city, country, season) VALUES (1991, 'Mike D', 'Men', 'Running', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required gender column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, sport, discipline, city, country, season) VALUES (1991, 'Mike D', '100km', 'Running', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required sport column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, discipline, city, country, season) VALUES (1991, 'Mike D', '100km', 'Men', 'Track', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required discipline column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, sport, city, country, season) VALUES (1991, 'Mike D', '100km', 'Men', 'Running', 'Athens', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required city column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, sport, discipline, country, season) VALUES (1991, 'Mike D', '100km', 'Men', 'Running', 'Track', 'Greece', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required country column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, sport, discipline, city, season) VALUES (1991, 'Mike D', '100km', 'Men', 'Running', 'Track', 'Athens', 'Summer')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that creates a Country table with a required season column', function (done) {
        ...
        emptyDb.run(query, () => {
            emptyDb.run(
                "INSERT INTO GoldMedal (year, name, event, gender, sport, discipline, city, country) VALUES (1991, 'Mike D', '100km', 'Men', 'Running', 'Track', 'Athens', 'Greece')",
                error => {
                    if (
                        error &&
                        error.toString().includes('NOT NULL constraint failed')
    ...
    it('should return a SQL query string that retrieves the number of gold medals won by a country', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (count === 3) {
                    ...
                    new Error(
                        error ||
                            `Expected number of medals to be 3, actual value was ${count}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the year a country won its most summer gold medals', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (year === 1980) {
                    ...
                    new Error(
                        error ||
                            `Expected year to be 1980, actual value was ${year}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the number of gold medals a country won in their best summer', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (count === 2) {
                    ...
                    new Error(
                        error ||
                            `Expected count to be 2, actual value was ${count}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the year a country won the most gedals', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (year === 1961) {
                    ...
                    new Error(
                        error ||
                            `Expected year to be 1961, actual value was ${year}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the discipline a country has won the most gold medals in', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (discipline === 'Jumping') {
                    ...
                    new Error(
                        error ||
                            `Expected discipline to be Jumping, actual value was ${discipline}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the sport a country has won the most gold medals in', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (sport === 'Equestrian') {
                    ...
                    new Error(
                        error ||
                            `Expected sport to be Equestrian, actual value was ${sport}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the event a country has won the most gold medals in', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (event === 'High Jump') {
                    ...
                    new Error(
                        error ||
                            `Expected sport to be High Jump, actual value was ${event}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the number of men who have won gold medals for a country', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (count === 2) {
                    ...
                    new Error(
                        error ||
                            `Expected number of men to be 2, actual value was ${count}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the number of women who have won gold medals for a country', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (count === 3) {
                    ...
                    new Error(
                        error ||
                            `Expected number of women to be 2, actual value was ${count}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves the athlete with the most gold medals for a country', function (done) {
        ...
        seededDb.get(query, (error, result) => {
            ...
            if (name === 'Michael Phelps') {
                    ...
                    new Error(
                        error ||
                            `Expected athlete to be Michael Phelps, actual value was ${name}`
                    )
                );
            }
        });
...
describe('orderedMedals', function () {
    ...
    it('should return a SQL query string that filters by a country', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (
                result.length === 2 &&
                (result[0].name === 'Babigail C' ||
                    result[1].name === 'Babigail C')
            ) {
                done();
            } else if (error) {
                done(new Error(error));
                    ...
                    new Error(
                        `Expected query to return 2 medals, actual number of returned medals was ${result.length}`
                    )
                );
            } else {
                done(
                    new Error(
                        `Expected returned medal athlete names to contain Babigail C, actual values were ${result[0].name} and ${result[1].name}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves medals optionally ordered ascending by a given field', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (result.length === 2 && result[0].name === 'Abigail C') {
                    ...
                    new Error(
                        `Expected first returned medal athlete name to be Abigail C, actual value was ${result[0].name}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves medals optionally ordered descending by a given field', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (result.length === 2 && result[0].name === 'Zabigail C') {
                    ...
                    new Error(
                        `Expected first returned medal athlete name to be Zabigail C, actual value was ${result[0].name}`
                    )
                );
            }
        });
...
describe('orderedSports', function () {
    ...
    it('should return a SQL query string that filters by a country', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            const resultNames = result.map(row => {
                return row.sport;
            });
            const expectedNames = ['Football', 'Zootball'];
            const resultsAreExpected = resultNames.every(name => {
            ...
            if (result.length === 2 && resultsAreExpected) {
                    ...
                    new Error(
                        `Expected query to return 2 sports, actual number of returned sports was ${result.length}`
                    )
                );
            } else {
                done(
                    new Error(
                        `Expected returned sports to contain 'Football' and 'Zootball', actual values were ${result[0].sport} and ${result[1].sport}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves sports optionally ordered ascending by a given field', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (result.length === 2 && result[0].sport === 'Football') {
                    ...
                    new Error(
                        `Expected first returned sport to be Football, actual value was ${result[0].sport}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that retrieves sports optionally ordered descending by a given field', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (result.length === 2 && result[0].sport === 'Zootball') {
                    ...
                    new Error(
                        `Expected first returned sport to be Zootball, actual value was ${result[0].sport}`
                    )
                );
            }
        });
    ...
    it('should return a SQL query string that calculates the percentage of wins that country has in each sport', function (done) {
        ...
        seededDb.all(query, (error, result) => {
            if (result.length === 2 && result[0].percent === 75) {
                    ...
                    new Error(
                        `Expected Football to represent 75%, actual value was ${result[0].name}%`
                    )
                );
            }
        });
